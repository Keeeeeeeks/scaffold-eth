...
const fs = require('fs');
const VFW = vorple.file.write();

export default function VorpLoad () {
    let savefile = []
    let transcriptFile = []

    /* TODO: write files for:
    1. The graph to save parsed stuff into object
    2. For this file to read that info, and save locally to Vorple
    VFW( graph );
    */
